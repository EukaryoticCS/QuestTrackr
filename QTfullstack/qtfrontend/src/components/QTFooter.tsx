...
const QTFooter = () => {
  return (
    ...
    <p className="col-md-4 mb-0 text-body-secondary">© 2023 Eukaryotic</p>
    ...
    <img alt="" src={QTLogo} height="100" width="100" className="mx-2" />
    </Link>
    ...
    <ul className="nav col-md-4 justify-content-end">
      ...
      <li className="nav-item"><Link to="#" className="nav-link px-2 text-body-secondary">Privacy</Link></li>
    </ul>
  </footer>
  )
}
